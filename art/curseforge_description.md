...
- **Modpacks are allowed and encouraged** — any platform, no need to ask. Use the official files and credit *NeroSecurity by Neroland* with links to this page and the [GitHub repository](https://github.com/Neroland/nerosecurity). Full terms: [LICENSE](https://github.com/Neroland/nerosecurity/blob/main/LICENSE).
...
- 🟢 **[Also on Modrinth](https://modrinth.com/mod/nerosecurity)**
